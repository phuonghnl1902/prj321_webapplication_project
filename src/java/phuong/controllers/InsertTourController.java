...
public class InsertTourController extends HttpServlet {
    ...
    private static final String INVALID = "newtour.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (id.length() == 0) {
                errObj.setIdErr("Tour id can not be blank!");
                valid = false;
            } else if (!id.matches("T" + "[0-9]{3}")) {
                errObj.setIdErr("Please check the id format. Ex: T001");
                valid = false;
            }
            ...
            TourDTO dto = new TourDTO(id, name, des, start, end, seat, price);
